...
IUSE="+alsa amr bindist coreaudio debug doc examples +filters g726 g729 gsm ilbc
	ipv6 ntp-timestamp opengl opus +ortp oss pcap portaudio pulseaudio qsa sdl silk +speex
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-2.9.0-v4l-automagic.patch" \
		"${FILESDIR}/${PN}-2.9.0-tests.patch" \
